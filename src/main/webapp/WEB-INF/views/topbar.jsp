  ...
  <div class="modal-content">
    <div class="modal-body chat-layout">
      ...
      <div class="chat-sidebar">
        <button class="btn btn-success w-100 mb-3" onclick="openCreateChatModal()">+ 그룹 채팅방 생성</button>
      ...
      <div class="chat-window">
        <div class="chat-header">
          <div class="left" id="chatHeaderTitle"></div>
          <div class="center">
          ...
          <div class="right">
            ...
            <button type="button" class="close-btn" onclick="closeChatModal()"><i class="bi bi-x"></i></button>
          </div>
        </div>
        ...
        <div class="chat-input">
          <label for="fileInput" class="file-attach"><i class="bi bi-paperclip"></i></label>
              ...
              <div class="tab-pane fade show active" id="pane-all" role="tabpanel" aria-labelledby="tab-all">
                <ul id="result-all" class="list-group list-group-flush small">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div><div class="fw-semibold"></div><div class="text-muted"></div></div>
